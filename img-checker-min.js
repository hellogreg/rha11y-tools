javascript: (() => {
  ...
  function l(e) {
    return (e = i(e) ? e.getRootNode().host : e);
  }
  function r(e) {
    let n = !1;
    e = l(e);
    ...
    let i = !!e.hidden;
    (n = n || i), t(" - hidden attribute: " + i);
    let a = "none" === getComputedStyle(e).display;
    (n = n || a), t(" - display:none: " + a);
    let r = !!e.ariaHidden || "true" === e.getAttribute("aria-hidden");
    (n = n || r), t(" - aria-hidden: " + r);
    let d = "presentation" === e.getAttribute("role");
    return (n = n || d), t(" - role=presentation: " + d), !!n;
  }
  function d(e) {
    function n(e) {
      return (
  ...
  function u(e) {
    ...
    return t(" - Has <title>: " + !!n), n && t(" - title: " + e.firstElementChild.textContent), !!n;
  }
  function c(e) {
  ...
  function f(e) {
    let n = e.ariaLabel || e.getAttribute("aria-label"),
      o = !!n;
    return t(" - Has aria-label: " + o), o && t(" - aria-label: " + n), !!o;
  }
  function g(e) {
  ...
  function b(e) {
    ...
    return (
      o &&
        ((a = !!(i = g(n))), t(" - aria-labelledby id: " + n), t(" - aria-labelledby value: " + i)),
      !!o
    );
  }
  function m(e) {
  ...
  function y(e) {
    ...
    let n = !1;
    c(e),
      (n = (n = (n = (n = n || !!u(e)) || !!f(e)) || !!b(e)) || d(e)),
      t("<svg> is accessible: " + n),
      o(e, n);
  }
  function h(e) {
    (e = i(e) ? e.getRootNode().host : e).style &&
      (e.style.backgroundImage.match("url") ||
        e.style.background.match("url") ||
        e.style.backgroundImage.match("var")) &&
  ...
  function N(e) {
    ...
    for (let o of n) {
      if (
        ("img" === o.nodeName.toLowerCase() && (t(), t("Located an <img>"), t(o.outerHTML), m(o)),
        "svg" === o.nodeName.toLowerCase() && (t(), t("Located an <svg>"), t(o.outerHTML), y(o)),
        a(o))
      ) {
        let i = o.shadowRoot,
          l = i.getRootNode().host.nodeName || "[unspecified]";
        (p += 1), t(), t("Checking " + l + " shadowRoot at nesting level " + p), N(i);
      }
      h(o);
    }
    let r = e.getRootNode().host ? e.getRootNode().host.nodeName : null;
    p > 0 && r && (t(), t("Exiting " + r + " shadowRoot at nesting level " + p), (p -= 1)), t();
  }
  !(function e() {
    t(), t("Initiating rha11y-img bookmarklet"), t();
    let n = document.body;
    N(n);
  })();
})();
